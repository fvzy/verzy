    ...
    <div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="title">
                            <h4>Nạp Qua MBBANK</h4>
                        </div>
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="#">Nạp Tiền</a></li>
                                <li class="breadcrumb-item active" aria-current="page">MBBANK</li>
                            </ol>
                        </nav>
                    </div>
                </div>
     ...
     <!-- Default Basic Forms Start -->
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">NẠP TIỀN BẰNG MBBANK</h4>
                        <p class="mb-30">Nạp tiền qua ví MBBANK tự động<br>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <b class="text-danger"
                            style="border: 2px dashed #e04f1a30; padding: 3px; color: #e53e3e!important;" id="copySDT">sotaikhoan</b> <a class="copy"
           ...
           <!-- Export Datatable start -->
             <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">LỊCH SỬ NẠP MBBANK</h4>
...
if($user['level'] == '810'){
    $cash = mysqli_query($ketnoi, "SELECT * FROM bentancoder_napmomo where `code` = 'Nạp từ MBBANK'");
}
