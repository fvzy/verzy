                    ...
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            ...
                            <div class="input-group custom">
                                ...
                                <div class="input-group-append custom">
                                    <span class="input-group-text"><i class="icon-copy ion-ios-call"></i></span>
                                </div>
                            </div>
                            <div class="input-group custom">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group mb-0">
                                        <button class="btn btn-primary btn-lg btn-block" id="bentancoder">Register</button>
</div>
